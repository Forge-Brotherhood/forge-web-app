            ...
            <SignedIn>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    className="relative h-8 w-8 rounded-full transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
                    aria-label="User menu"
                  >
                    <Avatar className="h-8 w-8 cursor-pointer">
                      <AvatarImage src={profile?.profileImageUrl || undefined} alt={profile?.displayName || user?.firstName || "User"} />
